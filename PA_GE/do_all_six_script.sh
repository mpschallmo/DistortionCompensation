...
set GEfwd = 'PRF1_AP' # mps 20201013
set GErev = 'oppPE_AP'
set SEfwd = 'AP_SE'
set SErev = 'REV_AP_SE'
set mag = 'b0_mag'
...
3dTcat -overwrite -prefix {$rawDir}/{$GEfwd}{$use_suffix}{$ext} {$rawDir}/{$GEfwd}{$use_suffix}{$ext}'[0..2]'
...
if ($GE_TOPUP == $yes) then
  ...
  mkdir $outDir
  set fwdScan = {$rawDir}/{$GEfwd}{$ext} # mps 20201013
