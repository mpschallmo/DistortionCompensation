...
foreach analysis ('uncorr' 'fugue' 'GE_topup' 'SE_topup' 'GE_qwarp' 'SE_qwarp' '12param')
    ...
    set epi = {$outDir}/epi_{$analysis}_SBRef
    set xform = {$outDir}/epi_{$analysis}_SBRef_al_3T_mat.aff12.1D
    set ixform = {$outDir}/inv_epi_{$analysis}_SBRef_al_3T_mat.aff12.1D
